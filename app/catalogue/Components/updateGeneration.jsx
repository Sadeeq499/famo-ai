                          ...
                          <div className="space-y-6 pb-5 pt-6">
                            <div className="sm:col-span-3 mt-[8px]">
                              ...
                              <div className="mt-2">
                                <select
                                  disabled={true}
                                  value={modelUpdateValues.llm_id}
                                  id="llm_id"
                                  name="llm_id"
                            ...
                            <div className="sm:col-span-4 mt-[10px]">
                              ...
                              <div className="mt-2">
                                <textarea
                                  ...
                                  id=""
                                  cols="20"
                                  value={modelUpdateValues.prompt}
                                  onChange={(e) => {
                                    setModelupdateValues({
                                      ...modelUpdateValues,
                                ...
                                {models?.map((item, i) => (
                                  <span
                                    ...
                                    className={`border-[3px] border-solid ${
                                      modelUpdateValues?.models?.includes(
                                        item.id
                                      ) && "border-indigo-700"
                                    }  rounded-[100%]`}
                                    onClick={() => {
                                      if (
                                        ...
                                        let idsValues =
                                          modelUpdateValues?.models?.filter(
                                            (idVal) => {
